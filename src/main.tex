...
\mysection{C - Application distribuée et intégration}
...
\ifslide{
  \mysection{E - Mise à échelle et production}
  ...
  \begin{block}{\textit{This is the End...}}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item \mylink{mailto:romain@redhat.com}{romain@redhat.com} (pro)
      \end{itemize}
    \end{itemize}
  \end{block}
\end{frame}
