...
\ifbook{
  ...
  la construction de systèmes d'information à l'aide de service hétérogènes, fonctionnenant sur des
  systèmes et des technologies complètement différentes. On cherche donc ainsi à réaliser des
  logiciels indépendants, exposants différent services métiers ou techniques, chacun "atomique".
  Pour réaliser les différents traitements nécessaires à ses utilisateurs, une application effectue
  donc une série d'appel à ses différents services, et agrège les résultats.
  ...
  des \textbf{interface} dans le langage de programmation Java, ainsi que d'un \textbf{annuaire} de
  service, permettant aux logiciels clients d'accéder de manière transparente au service capable
  d'assurer les fonctionnalités souhaités.
  ...
  \paragraph{} Un autre aspect, très puissant, des \textit{WebServices} était la capacité, pour un
  ...
  associée à \mylink{TODO}{SOA}}, ces derniers adressent la plupart des contraintes et
...
\ifbook{
  ...
  défini. ReST - ou \textit{Representationnal State Transfer} en anglais, est en fait une sorte
  d'analyse des bonnes pratiques constatés sur l'ensemble de l'internet.
  ...
  l'industrie, comme beaucoupl claire et approprié que XML. Néanmoins, si les services de types ReST
...
\ifbook{
  ...
  effectuant un parallèle avec les bus de communication électroniques, ces solutions sont donc
  apparu pour devenir cet intermédiaire nécessaire et pourtant presque invisible, entre les
