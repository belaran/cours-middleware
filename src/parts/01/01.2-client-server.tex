...
\ifbook{
  ...
  capable d'effectuer des traitements par eux-même, et donc offrir des fonctionnalités
  ...
  \paragraph{} Si cette nouvelle déclinaison du modèle aboutit clairement à une productivité
...
\ifbook{
  ...
  permet de sauvegarder sur une unité de stockage (en langage vernaculaire, un "disque dur") un ensemble d'information de manière séquentielle. On peut retrouver les informations stockées à
  ...
  choisie pour les fichiers, des fichiers spéciaux, les \textbf{répertoires} ont été conçus pour
  permettre de ranger aisément et de hiérarchiser les fichiers.
