...
\ifbook{
  \mysubsubsection{Limites physique d'un ordinateur}
...
\ifbook{
  ...
  \ref{algo-exemple}  (ppage \pageref{algo-exemple}), sera donc capable de réordonner l'ensemble du
  ...
  contenter de calculer, une fois pour toute, la taille de chaque cellule,iu  puis de les trier de
