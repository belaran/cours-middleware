\ifbook{
  ...
  une simple tâche. C'est donc pour ces raisons, entre autres, que les concepteurs de HTTP et de HTML
...
\demoframe{Le protocole HTTP}{
  \begin{block}{Démonstrations}
    \begin{itemize}
      ...
      \item connection complète avec les developpers tools de Google Chrome
    \end{itemize}
  \end{block}
}
...
\ifbook{
  ...
  \paragraph{} Le protocole HTTP, et son format de données, HTML, a eu le succès qu'on connait, et
...
\ifbook {
  ...
  peut être rendu - à peu près, de manière similaire, quelque soit le système d'exploitation
  utilisé.
  ...
  suffisante pour l'application, ou recruter un développeur sans que celui-ci n'est besoin d'autres
  ...
  programmation}, et l'ecosystème qui les entoure apporte son lot de composants prêts à utiliser 
