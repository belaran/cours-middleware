...
\ifslide {
  \begin{frame}{Le "Web"}
  TODO: Dessin de synthèse "web" début
  \end{frame}
}
...
\ifbook{
 ...
 TODO: Extrait de fichier HTML, souligné le JavaScript et le CSS
...
\ifbook {
  \subsubsection{Conteneur d'exéctution d'application "web"}
  ...
  \paragraph{} En outre, ces technologies promeuvent un \textbf{modèle de programmation}, et
  fournissent des composants prêt à utiliser destiné à faciliter grandement le développement
  d'application "web" robuste et capable de monter en charge.
  %TODO: dessin sur le conteneur JVM ?
}
