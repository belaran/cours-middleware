\ifbook {
  ...
  s'appuie souvent des composants logicielle spécifique à Java.}
...
\ifbook {
  ...
  \paragraph{} Si ce modèle fonctionne très bien, et de nombreuses applications très efficace ont été
...
\ifslide{
  \begin{frame}{Fuite mémoire}
   \begin{center}
     % TODO: slide fuite mémoire
     Pourquoi ne pas développer en langage natif ?
...
\ifbook{
  ...
  faire le \textbf{nettoyage}. En anglais, on emploi fréquemment le terme de \textit{\textbf{Garbage
  Collection}}.
...
\ifbook {
  ...
  lecteur de bien saisir les concepts sous jacent. Pour être didactique, cette section contiendra
