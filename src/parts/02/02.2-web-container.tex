...
\ifbook{
  ...
  spécifique au conteneur de servlet du monde Java ou même à des produits spécifiques, tel
...
\ifbook{
 ...
 programmeur de la complexité du protocole HTTP, fourni des objets Java simple à utiliser et fournit,
 au final, un cavena, très similaire à celui d'un simple programme, pour développer son programme.
 ...
 simple pour manipuler la Session.
...
\ifbook{
 ...
 une syntaxe plus approprié, désigné sous le nom de \textit{Java Server Pages}, ou JSP.
